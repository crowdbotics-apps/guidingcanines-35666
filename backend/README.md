...
## Project Structure
    ...
    ├── guidingcanines_35666  # Django project configurations
...
1. Clone this repo and `cd guidingcanines_35666`
...
2. Clone this repo and `cd guidingcanines_35666`
